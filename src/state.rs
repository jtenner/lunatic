...
pub(crate) struct Resources {
    ...
    pub(crate) wgpu_instances: HashMapId<wgpu::Instance>,
    pub(crate) wgpu_adapters: HashMapId<wgpu::Adapter>,
    pub(crate) wgpu_devices: HashMapId<wgpu::Device>,
    pub(crate) wgpu_queues: HashMapId<wgpu::Queue>,
}
